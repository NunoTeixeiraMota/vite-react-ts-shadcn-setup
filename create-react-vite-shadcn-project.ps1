...
Write-Host "Installing shadcn/ui and its dependencies..."
...
Write-Host "Installing tailwindcss-animate..."
...
Write-Host "Updating tailwind.config.js..."
@"
...
Write-Host "Creating components.json..."
@"
{
...
Write-Host "Updating src/index.css..."
@"
@tailwind base;
@tailwind components;
@tailwind utilities;
...
Write-Host "Creating src/lib/utils.ts..."
@"
...
Write-Host "Creating a basic button component..."
@"
...
# Update App.tsx to use the new button component
...
function App() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-background text-foreground">
      <h1 className="text-4xl font-bold mb-4">Vite + React + TS + shadcn/ui</h1>
...
Write-Host "Updating vite.config.ts..."
@"
...
Write-Host "Project setup complete! To start your development server, run:"
Write-Host "cd $PROJECT_NAME; pnpm run dev"
